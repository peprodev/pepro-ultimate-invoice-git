...
<table class="footersignatureauto">
  <tr>
    ...
    <td colspan="6" style="vertical-align: top; text-align:center;">
      <p style="text-align:center;">مهر و امضای خریدار:<br><br>
        <img class="footer-img uk-align-center" alt="" style="width:2cm; {{{customer_signature_css}}}" src="{{{customer_signature}}}">
      </p>
    </td>
  </tr>
</table>
