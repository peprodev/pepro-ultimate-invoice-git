<div class="page body">
  <table id="headertitles">
    <tr class="headtr">
      ...
      <td class="header-item-wrapper" style="width: 70%; font-weight: bold; font-size: 1.7rem; text-align: left; padding: 0.1cm .5cm; display: block !important;">{{{invoice_title}}}</td>
